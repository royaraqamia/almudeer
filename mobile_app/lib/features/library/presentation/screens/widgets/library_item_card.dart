...
/// âœ… P0: Accessible Library Item Card
...
/// âœ… P0: Accessible Library Item List Card (for files view)
/// - P0: Proper Semantics labels
/// - P0: 44px minimum touch targets
/// - P0: Focus/hover indicators
/// - P2: Design token compliance
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      widget.item.isUploading
                                          ...
                                          : '${widget.item.formattedSize}${widget.item.formattedSize.isNotEmpty ? ' â€¢ ' : ''}${widget.item.formattedDate}',
