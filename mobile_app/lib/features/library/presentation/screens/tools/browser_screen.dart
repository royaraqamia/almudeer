...
import 'package:almudeer_mobile_app/features/library/presentation/screens/tools/downloads_screen.dart';
...
import 'package:almudeer_mobile_app/features/library/presentation/screens/tools/browser_history_screen.dart';
...
class _BrowserScreenState extends State<BrowserScreen> {
  ...
  void _showClearBrowsingDataDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('ظ…ط³ط­ ط¨ظٹط§ظ†ط§طھ ط§ظ„طھطµظپط­'),
        content: const Text(
          'ط³ظٹطھظ… ظ…ط³ط­ ط§ظ„ط³ط¬ظ„ ظˆظ…ظ„ظپط§طھ طھط¹ط±ظٹظپ ط§ظ„ط§ط±طھط¨ط§ط· ظˆط§ظ„ط°ط§ظƒط±ط© ط§ظ„ظ…ط¤ظ‚طھط©. ظ‡ظ„ ط£ظ†طھ ظ…طھط£ظƒط¯طں',
        ),
        actions: [
          TextButton(
            ...
            onPressed: () async {
              ...
              if (mounted) {
                messenger.showSnackBar(
                  const SnackBar(
                    content: Text('طھظ… ظ…ط³ط­ ط¨ظٹط§ظ†ط§طھ ط§ظ„طھطµظپط­ ط¨ظ†ط¬ط§ط­'),
  ...
  void _addNewTab({
    ...
    if (_tabs.length >= _maxTabs) {
      ...
      AnimatedToast.info(
        context,
        'طھظ… ط¥ط؛ظ„ط§ظ‚ ط£ظ‚ط¯ظ… طھط¨ظˆظٹط¨ ط¨ط³ط¨ط¨ ط§ظ„ظˆطµظˆظ„ ظ„ظ„ط­ط¯ ط§ظ„ط£ظ‚طµظ‰',
      );
    }
        ...
        NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) {
            ...
            if (_adBlocker.isAdultContent(request.url)) {
              AnimatedToast.error(
                context,
                'طھظ… ط­ط¸ط± ظ‡ط°ط§ ط§ظ„ظ…ظˆظ‚ط¹ ط¨ظ…ظˆط¬ط¨ ط³ظٹط§ط³ط© ط§ظ„ظ…ط­طھظˆظ‰ ط§ظ„ط¢ظ…ظ†',
              );
              return NavigationDecision.prevent;
            }
            ...
            if (downloadExtensions.any((ext) => navUrl.endsWith(ext))) {
              ...
              AnimatedToast.success(context, 'ط¨ط¯ط£ طھط­ظ…ظٹظ„ ط§ظ„ظ…ظ„ظپ');
              return NavigationDecision.prevent;
            }
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('ط­ظپط¸ ط§ظ„طµظˆط±ط©'),
              onTap: () {
                Navigator.pop(context);
                _downloadManager.startDownload(imageUrl);
                AnimatedToast.success(context, 'ط¨ط¯ط£ طھط­ظ…ظٹظ„ ط§ظ„طµظˆط±ط©');
              },
            ),
            ListTile(
              leading: const Icon(SolarLinearIcons.shareCircle),
              title: const Text('ظ…ط´ط§ط±ظƒط© ط±ط§ط¨ط· ط§ظ„طµظˆط±ط©'),
              onTap: () {
                Navigator.pop(context);
  ...
  void _loadUrl() {
    ...
    try {
      ...
      AnimatedToast.error(context, 'ط±ط§ط¨ط· ط؛ظٹط± طµط§ظ„ط­');
    }
  }
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'ط£ط¯ط®ظ„ ط§ظ„ط±ط§ط¨ط· ظ‡ظ†ط§...',
              ...
              if (value == 'search') {
                ...
                AnimatedToast.success(
                  ...
                  _bookmarkService.isBookmarked(tab.url)
                      ? 'طھظ…طھ ط¥ط¶ط§ظپط© ط§ظ„ط¥ط´ط§ط±ط© ط§ظ„ظ…ط±ط¬ط¹ظٹط©'
                      : 'طھظ…طھ ط¥ط²ط§ظ„ط© ط§ظ„ط¥ط´ط§ط±ط© ط§ظ„ظ…ط±ط¬ط¹ظٹط©',
                );
              ...
              const PopupMenuItem(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text('ط§ظ„ط³ط¬ظ„ ظˆط§ظ„ط¥ط´ط§ط±ط§طھ'),
                  ],
                ),
              ),
              const PopupMenuItem(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text('ظ…ط³ط­ ط¨ظٹط§ظ†ط§طھ ط§ظ„طھطµظپط­'),
                  ],
                ),
              ),
              PopupMenuItem(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      _bookmarkService.isBookmarked(activeTab.url)
                          ? 'ط¥ط²ط§ظ„ط© ط§ظ„ط¥ط´ط§ط±ط© ط§ظ„ظ…ط±ط¬ط¹ظٹط©'
                          : 'ط¥ط¶ط§ظپط© ط¥ط´ط§ط±ط© ظ…ط±ط¬ط¹ظٹط©',
                    ),
                  ],
                ),
              ),
                      ...
                      Positioned.fill(
                        child: AnimatedOpacity(
                          ...
                          child: Container(
                            color: Theme.of(context).scaffoldBackgroundColor,
                            child: Semantics(
                              label: 'ط¬ط§ط±ظٹ طھط­ظ…ظٹظ„ ط§ظ„طµظپط­ط©',
                              child: Center(
                                child: Column(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                    ...
                                    const SizedBox(height: 16),
                                    Text(
                                      'ط¬ط§ط±ظٹ طھط­ظ…ظٹظ„ ط§ظ„طµظپط­ط©...',
                                      style: TextStyle(
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: const InputDecoration(
                          hintText: 'ط§ظ„ط¨ط­ط« ظپظٹ ط§ظ„طµظپط­ط©...',
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () {
                  ...
                  AnimatedToast.success(context, 'طھظ… ظ†ط³ط® ط§ظ„ط±ط§ط¨ط·');
                },
              ),
            ],
          ),
...
class _WebViewWithErrorHandlingState extends State<_WebViewWithErrorHandling> {
  ...
  final String _errorMessage = 'ط­ط¯ط« ط®ط·ط£ ظپظٹ طھط­ظ…ظٹظ„ ط§ظ„طµظپط­ط©';
