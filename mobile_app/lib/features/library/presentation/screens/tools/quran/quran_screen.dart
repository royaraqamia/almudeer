...
import 'package:almudeer_mobile_app/features/library/presentation/screens/tools/quran/surah_detail_screen.dart';
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'ط§ظ„ط¢ظٹط© ط±ظ‚ظ… ${quranProvider.lastVerse}',
                              style: const TextStyle(
                                color: Colors.white,
                                fontSize: 14,
                                fontFamily: 'IBM Plex Sans Arabic',
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            '${quran.getVerseCount(surahNumber)} ط¢ظٹط©',
                                            style: TextStyle(
                                              fontFamily:
                                                  'IBM Plex Sans Arabic',
                                              color: theme
