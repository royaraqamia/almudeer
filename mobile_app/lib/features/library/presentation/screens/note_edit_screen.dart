...
/// âœ… P1: Enhanced Note Edit Screen
...
class _NoteEditScreenState extends State<NoteEditScreen> {
  ...
  void _loadPermissions() {
    ...
    // Priority: AuthProvider cache â†’ LibraryProvider context â†’ cached storage
            ...
            children: [
              ...
              ListenableBuilder(
                ...
                builder: (context, child) {
                  ...
                  return Semantics(
                    textField: true,
                    label: 'ط¹ظ†ظˆط§ظ† ط§ظ„ظ…ظ„ط§ط­ط¸ط©',
                    child: TextField(
    ...
    return Container(
      ...
      child: ListenableBuilder(
        ...
        builder: (context, child) {
          ...
          return Semantics(
            textField: true,
            label: 'ظ…ط­طھظˆظ‰ ط§ظ„ظ…ظ„ط§ط­ط¸ط©',
            child: TextField(
              ...
              decoration: const InputDecoration(
                hintText: 'ط§ظƒطھط¨ ظ…ط§ طھط±ظٹط¯ ظ‡ظڈظ†ط§...',
                border: InputBorder.none,
                enabledBorder: InputBorder.none,
                focusedBorder: InputBorder.none,
                filled: false,
