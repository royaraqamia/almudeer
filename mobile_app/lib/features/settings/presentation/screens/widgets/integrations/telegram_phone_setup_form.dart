...
class _TelegramPhoneSetupFormState extends State<TelegramPhoneSetupForm> {
  ...
  String _getStepSubtitle() {
    switch (_currentStep) {
      case 1:
        return 'ط£ط¯ط®ظ„ ط±ظ‚ظ… ظ‡ط§طھظپظƒ ط§ظ„ظ…ط³ط¬ظ„ ظپظٹ Telegram';
      case 2:
        return 'طھظ… ط¥ط±ط³ط§ظ„ ط§ظ„ط±ظ…ط² ط¥ظ„ظ‰ طھط·ط¨ظٹظ‚ Telegram';
      case 3:
        return 'ط­ط³ط§ط¨ظƒ ظ…ط­ظ…ظٹ ط¨ظƒظ„ظ…ط© ظ…ط±ظˆط± ط«ظ†ط§ط¦ظٹط©';
      default:
        return '';
    }
  }
