              ...
              children: [
                Row(
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        'ظƒظٹظپظٹظژظ‘ط© ط¥ظ†ط´ط§ط، ط¨ظˆطھ طھظٹظ„ظٹط¬ط±ط§ظ…',
                ...
                _buildInstructionStep(
                  '1. ط§ظپطھط­ طھظٹظ„ظٹط¬ط±ط§ظ… ظˆط§ط¨ط­ط« ط¹ظ† BotFather@',
                  null,
                  theme,
                ),
                _buildInstructionStep('2. ط£ط±ط³ظ„ ط§ظ„ط£ظ…ط± newbot/', null, theme),
                _buildInstructionStep(
                  '3. ط§ط®طھط± ط§ط³ظ…ظ‹ط§ ظˆظ…ط¹ط±ظگظ‘ظپظ‹ط§ ظ„ظ„ط¨ظˆطھ',
                  null,
                  theme,
                ),
                _buildInstructionStep(
                  '4. ط§ظ†ط³ط® ط§ظ„طھظڈظ‘ظˆظƒظ† ط§ظ„ط°ظٹ ط³طھط­طµظ„ ط¹ظ„ظٹظ‡',
                  null,
                  theme,
                ),
              ],
