...
import 'package:almudeer_mobile_app/core/services/network_connectivity_service.dart';
import 'package:almudeer_mobile_app/core/utils/premium_toast.dart';
import 'package:almudeer_mobile_app/features/inbox/presentation/screens/image_viewer_screen.dart';
...
class _UniversalViewerScreenState extends State<UniversalViewerScreen>
  ...
  Future<void> _downloadFileWithProgress(String url, String fileName) async {
    ...
    if (!isConnected) {
      throw Exception('ظ„ط§ ظٹظˆط¬ط¯ ط§طھطµط§ظ„ ط¨ط§ظ„ط¥ظ†طھط±ظ†طھ. ظٹط±ط¬ظ‰ ط§ظ„طھط­ظ‚ظ‚ ظ…ظ† ط§طھطµط§ظ„ظƒ ظˆط§ظ„ظ…ط­ط§ظˆظ„ط© ظ…ط±ط© ط£ط®ط±ظ‰.');
    }
    ...
    if (!isWifi && mounted) {
      ...
      PremiumToast.show(
        context,
        'ط¬ط§ط±ظٹ ط§ظ„طھط­ظ…ظٹظ„ ط¨ط§ط³طھط®ط¯ط§ظ… ط¨ظٹط§ظ†ط§طھ ط§ظ„ط¬ظˆط§ظ„',
