...
class InboxRepository {
  ...
  Future<ConversationDetailResponse> getConversationDetail(
    ...
    try {
      ...
      if (senderContact == '__saved_messages__') {
        return ConversationDetailResponse(
          senderName: 'ط§ظ„ط±ظ‘ظژط³ط§ط¦ظ„ ط§ظ„ظ…ط­ظپظˆط¸ط©',
  ...
  Future<Map<String, dynamic>> sendMessage(
    ...
    try {
      ...
      throw MessageSendException(
        'ط§ظ†طھظ‡طھ ظ…ظ‡ظ„ط© ط§ظ„ط§طھطµط§ظ„',
        errorType: MessageSendErrorType.network,
        originalException: e,
      );
      ...
      throw MessageSendException(
        'ط®ط·ط£ ظپظٹ ط§ظ„ط®ط§ط¯ظ…طŒ ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ„ط§ط­ظ‚ط§ظ‹',
        errorType: MessageSendErrorType.server,
        originalException: e,
      );
    } catch (e) {
      ...
      throw MessageSendException(
        'ط­ط¯ط« ط®ط·ط£ ط؛ظٹط± ظ…طھظˆظ‚ط¹: ${e.toString()}',
