...
class _MediaPreviewDialogState extends State<MediaPreviewDialog> {
  ...
  void _confirm() {
    ...
    if (caption.length > maxCaptionLength) {
      AnimatedToast.error(
        context,
        'ط§ظ„طھط¹ظ„ظٹظ‚ ط·ظˆظٹظ„ ط¬ط¯ط§ظ‹. ط§ظ„ط­ط¯ ط§ظ„ط£ظ‚طµظ‰ ظ‡ظˆ $maxCaptionLength ط­ط±ظپ',
      );
      return;
    }
  ...
  Widget _buildHeader(ThemeData theme, bool isDark) {
    ...
    switch (widget.mediaType) {
      case 'image':
        title = 'ظ…ط¹ط§ظٹظ†ط© ط§ظ„طµظˆط±ط©';
        icon = SolarLinearIcons.gallery;
        iconColor = Colors.purple;
        break;
      case 'video':
        title = 'ظ…ط¹ط§ظٹظ†ط© ط§ظ„ظپظٹط¯ظٹظˆ';
        icon = SolarLinearIcons.videocamera;
        iconColor = Colors.red;
        break;
      default:
        title = 'ظ…ط¹ط§ظٹظ†ط© ط§ظ„ظ…ظ„ظپ';
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'ط§ظƒطھط¨ طھط¹ظ„ظٹظ‚ط§ظ‹ ط¹ظ„ظ‰ ظ‡ط°ط§ ط§ظ„ظ…ظ„ظپ...',
              hintStyle: TextStyle(
                fontSize: 15,
          ...
          if (isOverLimit) ...[
            const SizedBox(height: 8),
            Text(
              'ط§ظ„طھط¹ظ„ظٹظ‚ ط·ظˆظٹظ„ ط¬ط¯ط§ظ‹. ظٹط±ط¬ظ‰ ط§ط®طھطµط§ط±ظ‡.',
              style: theme.textTheme.labelSmall?.copyWith(
                color: Colors.red,
              ),
            ),
