              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        title.isNotEmpty ? title : 'ظ…ظ‡ظ…ط©',
          ...
          : () async {
              try {
                ...
                if (mounted) {
                  ...
                  if (context.mounted) {
                    AnimatedToast.success(context, 'طھظ…طھ ط§ظ„ط¥ط¶ط§ظپط© ظ„ظ…ظ‡ط§ظ…ظٹ');
                  }
                }
              } catch (e) {
                if (mounted && context.mounted) {
                  AnimatedToast.error(context, 'ظپط´ظ„ ط§ظ„ط¥ط¶ط§ظپط©: $e');
                }
              }
            },
      child: Container(
