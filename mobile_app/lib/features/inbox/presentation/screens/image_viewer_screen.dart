    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            _isNetworkError ? 'ط®ط·ط£ ظپظٹ ط§ظ„ط´ط¨ظƒط©' : 'ظپط´ظ„ طھط­ظ…ظٹظ„ ط§ظ„طµظˆط±ط©',
    ...
    if (path == null && widget.imageUrl != null) {
      ...
      try {
        ...
        if (context.mounted) {
          PremiumToast.show(
            context,
            'ظپط´ظ„ طھط¬ظ‡ظٹط² ط§ظ„طµظˆط±ط© ظ„ظ„ظ…ط´ط§ط±ظƒط©',
  ...
  Future<void> _saveImage(BuildContext context) async {
    ...
    if (path == null && widget.imageData == null) {
      if (context.mounted) {
        PremiumToast.show(
          context,
          'ط§ظ„طµظˆط±ط© ط؛ظٹط± ظ…طھظˆظپط±ط© ظ„ظ„ط­ظپط¸',
          icon: SolarLinearIcons.dangerCircle,
          isError: true,
        );
      }
