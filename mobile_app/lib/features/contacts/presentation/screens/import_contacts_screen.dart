...
import 'package:almudeer_mobile_app/core/widgets/app_avatar.dart'; // Added AppAvatar import
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          AnimatedToast.error(context, 'ط­ط¯ط« ط®ط·ط£ ظپظٹ طھط­ظ…ظٹظ„ ط£ط±ظ‚ط§ظ… ط§ظ„ظ‡ظˆط§طھظپ: $e');
        });
      }
    }
  }
    ...
    if (mounted) {
      if (successCount > 0) {
        AnimatedToast.success(
          context,
          'طھظ…ظ‘ظژ ط§ط³طھظٹط±ط§ط¯ $successCount ط±ظ‚ظ… ظ‡ط§طھظپ ط¨ظ†ط¬ط§ط­',
        );
        Navigator.pop(context, true); // Return true to refresh list
      } else if (failCount > 0) {
        AnimatedToast.error(context, 'ظپط´ظ„ ط§ظ„ط§ط³طھظٹط±ط§ط¯');
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          'ط§ط³طھظٹط±ط§ط¯ ط£ط±ظ‚ط§ظ… ط§ظ„ظ‡ظˆط§طھظپ',
  ...
  Widget _buildPremiumHeader(ThemeData theme, bool isDark) {
    return Container(
      ...
      child: AppTextField(
        ...
        hintText: 'ط¨ط­ط« ط¨ط§ط³ظ… ط£ظˆ ط±ظ‚ظ… ط§ظ„ظ‡ط§طھظپ...',
      ...
      child: ElevatedButton(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              _isImporting
                  ? 'ط¬ط§ط±ظٹ ط§ظ„ط§ط³طھظٹط±ط§ط¯... (${(_importProgress * 100).toInt()}%)'
                  : 'ط§ط³طھظٹط±ط§ط¯ (${_selectedIds.length})',
