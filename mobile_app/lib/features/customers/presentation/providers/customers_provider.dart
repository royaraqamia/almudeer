  ...
  Future<void> bulkDelete() async {
    ...
    try {
      ...
      if (result['success'] == false) {
        ...
        _error = result['message'] ?? 'ظپط´ظ„ ط§ظ„ط­ط°ظپ';
        notifyListeners();
      ...
      _error = 'ظپط´ظ„ ط­ط°ظپ ط¨ط¹ط¶ ط§ظ„ط¹ظ†ط§طµط±';
      notifyListeners();
      loadCustomers(refresh: true);
    }
  }
      ...
      try {
        ...
        if (result['exists'] == true) {
          _foundUsernameDetails =
              result['full_name'] ?? result['company_name'] ?? 'ظ…ط³طھط®ط¯ظ… ظ…ط¹ط±ظˆظپ';
          _usernameNotFound = false;
        } else {
          _foundUsernameDetails = null;
  ...
  Future<Map<String, dynamic>> addCustomer(Map<String, dynamic> data) async {
    ...
    try {
      ...
      if (isSuccess) {
        ...
        return {
          'success': true,
          'message': result['message'] ?? 'طھظ…ظ‘ظژ ط¥ط¶ط§ظپط© ط§ظ„ط´ظ‘ظژط®طµ ط¨ظ†ط¬ط§ط­',
        };
      }

      return {
        'success': false,
        'message': result['error'] ?? result['message'] ?? 'ظپط´ظ„طھ ط§ظ„ط¥ط¶ط§ظپط©',
      };
    } catch (e) {
      debugPrint('Add customer failed: $e');
      return {'success': false, 'message': 'ط­ط¯ط« ط®ط·ط£ ط؛ظٹط± ظ…طھظˆظ‚ط¹ ط£ط«ظ†ط§ط، ط§ظ„ط¥ط¶ط§ظپط©'};
    }
  }
