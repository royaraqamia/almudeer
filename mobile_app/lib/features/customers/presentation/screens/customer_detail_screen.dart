...
import 'package:almudeer_mobile_app/core/utils/logger.dart';
...
import 'package:almudeer_mobile_app/features/customers/presentation/widgets/customers/customer_contact_card.dart';
...
class _CustomerDetailScreenState extends State<CustomerDetailScreen>
  ...
  void _subscribeToStatus({bool immediate = false}) {
    ...
    // conversation â†’ customer detail â†’ back to conversation (without reload)
  }
    ...
    try {
      ...
      if (difference.inMinutes < 1) {
        ...
        try {
          ...
          return 'ط¢ط®ط± ط¸ظ‡ظˆط± ${intl.DateFormat.yMd('ar_AE').format(localDate).toEnglishNumbers}';
        }
      }
    } catch (e, stackTrace) {
      if (kDebugMode) {
  ...
  Future<void> _openEditCustomer() async {
    ...
    final result = await PremiumBottomSheet.show<dynamic>(
      context: context,
      title: wasNewContact ? 'ط¥ط¶ط§ظپط©' : 'طھط¹ط¯ظٹظ„',
        ...
        builder: (context, setModalState) {
          ...
          return Column(
            ...
            children: [
              ...
              _buildTextField(
                _phoneController,
                'ط±ظ‚ظ… ط§ظ„ظ‡ط§طھظپ (ط§ط®طھظٹط§ط±ظٹ)',
              ...
              AppGradientButton(
                onPressed: hasChanges()
                    ...
                    : null,
                text: wasNewContact ? 'ط¥ط¶ط§ظپط©' : 'ط­ظپط¸ ط§ظ„طھظژظ‘ط؛ظٹظٹط±ط§طھ',
              ),
            ],
          );
        },
  ...
  Future<void> _saveCustomerDetails(_EditOperationType operationType) async {
    ...
    if (!nameValidation.isValid) {
      AnimatedToast.error(context, nameValidation.errorMessage ?? 'ط§ظ„ط§ط³ظ… ط؛ظٹط± طµط§ظ„ط­');
      return;
    }

    final phoneValidation = Validators.validatePhone(_phoneController.text.trim());
    if (!phoneValidation.isValid) {
      AnimatedToast.error(context, phoneValidation.errorMessage ?? 'ط±ظ‚ظ… ط§ظ„ظ‡ط§طھظپ ط؛ظٹط± طµط§ظ„ط­');
      return;
    }

    final usernameValidation = Validators.validateUsername(_usernameController.text.trim());
    if (!usernameValidation.isValid) {
      AnimatedToast.error(context, usernameValidation.errorMessage ?? 'ط§ظ„ظ…ط¹ط±ظگظ‘ظپ ط؛ظٹط± طµط§ظ„ط­');
      return;
    }
    ...
    try {
      ...
      if (mounted && !_isDisposed && isSuccess) {
        ...
        AnimatedToast.success(
          ...
          operationType == _EditOperationType.update && customerId != null
              ? 'طھظ…ظژظ‘ طھط­ط¯ظٹط« ط§ظ„ط¨ظٹط§ظ†ط§طھ ط¨ظ†ط¬ط§ط­'
              : 'طھظ…ظژظ‘طھ ط§ظ„ط¥ط¶ط§ظپط© ط¨ظ†ط¬ط§ط­',
        );
        ...
        final errorMessage = response['error']?.toString() ?? 
            ...
            (operationType == _EditOperationType.update && customerId != null
                ? 'ظپط´ظ„ طھط­ط¯ظٹط« ط§ظ„ط¨ظٹط§ظ†ط§طھ - طھط£ظƒط¯ ظ…ظ† ط§طھطµط§ظ„ظƒ ط¨ط§ظ„ط¥ظ†طھط±ظ†طھ'
                : 'ظپط´ظ„طھ ط§ظ„ط¥ط¶ط§ظپط© - طھط£ظƒط¯ ظ…ظ† ط§طھطµط§ظ„ظƒ ط¨ط§ظ„ط¥ظ†طھط±ظ†طھ');
      ...
      if (mounted && !_isDisposed) {
        ...
        final errorType = e.toString().contains('SocketException') || e.toString().contains('Network')
            ...
            : 'ط­ط¯ط« ط®ط·ط£ ط£ط«ظ†ط§ط، ط­ظپط¸ ط§ظ„ط¨ظٹط§ظ†ط§طھ - ط­ط§ظˆظ„ ظ…ط±ط© ط£ط®ط±ظ‰';
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (!didPop && _isLoadingFullDetails) {
            AnimatedToast.info(context, 'ط¬ط§ط±ظٹ طھط­ظ…ظٹظ„ ط§ظ„ط¨ظٹط§ظ†ط§طھ...');
          }
        },
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'ظ„ط§ طھظˆط¬ط¯ ط¨ظٹط§ظ†ط§طھ ظ„ظ„ط´ط®طµ',
            ...
            Text(
              'طھط¹ط°ط± طھط­ظ…ظٹظ„ ط¨ظٹط§ظ†ط§طھ ظ‡ط°ط§ ط§ظ„ط´ط®طµ',
    ...
    return Scaffold(
      floatingActionButton: _isCurrentUser == true
          ...
          : Padding(
              ...
              child: Semantics(
                label: _getIsNewContactCached() ? 'ط¥ط¶ط§ظپط© ط´ط®طµ' : 'طھط¹ط¯ظٹظ„ ط§ظ„ط´ط®طµ',
                button: true,
                child: PremiumFAB(
              ...
              children: [
                SizedBox(
                  ...
                  child: AppGradientButton(
                    ...
                    text: _isCurrentUser == true ? 'ط±ط³ط§ط¦ظ„ظٹ' : 'ظ…ط±ط§ط³ظ„ط©',
  ...
  Future<void> _navigateToInternalChat() async {
    ...
    try {
      ...
      if (username == null || username.isEmpty) {
        AnimatedToast.error(context, 'ظ„ط§ ظٹظˆط¬ط¯ ظ…ط¹ط±ظگظ‘ظپ ظ„ظ‡ط°ط§ ط§ظ„ط´ظژظ‘ط®طµ ظ„ظ„ظ…ط±ط§ط³ظ„ط©');
        return;
      }
      ...
      if (mounted) {
        AnimatedToast.error(context, 'ظپط´ظ„ ظپطھط­ ط§ظ„ظ…ط­ط§ط¯ط«ط©');
      }
    } finally {
      if (mounted) {
  ...
  Future<void> _navigateToSavedMessages() async {
    ...
    try {
      final conversation = Conversation(
        id: -1,
        channel: 'almudeer',
        senderName: 'ط±ط³ط§ط¦ظ„ظٹ ط§ظ„ظ…ط­ظپظˆط¸ط©',
  ...
  Widget _buildPremiumAvatar(ThemeData theme, bool isVip, bool isDark) {
    ...
    return RepaintBoundary(
      child: AppAvatar(
        ...
        semanticsLabel: 'طµظˆط±ط© $_displayName',
      ),
    );
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _avatarRetryCount >= _maxAvatarRetries ? 'ط§ط¶ط؛ط· ظ„ط¥ط¹ط§ط¯ط© ط§ظ„ظ…ط­ط§ظˆظ„ط©' : 'ط¥ط¹ط§ط¯ط© ط§ظ„ظ…ط­ط§ظˆظ„ط©',
              style: TextStyle(
                fontSize: 10,
                color: isDark ? Colors.white70 : Colors.black54,
                fontWeight: FontWeight.w500,
