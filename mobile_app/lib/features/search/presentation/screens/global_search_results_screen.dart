...
import 'package:almudeer_mobile_app/features/users/data/models/user.dart';
...
import 'package:almudeer_mobile_app/features/users/data/repositories/users_repository.dart';
...
class _GlobalSearchResultsScreenState extends State<GlobalSearchResultsScreen> {
  ...
  String _formatDueDate(DateTime date) {
    ...
    if (difference == 0) return 'ط§ظ„ظٹظˆظ…';
    if (difference == 1) return 'ط؛ط¯ط§ظ‹';
    if (difference == -1) return 'ط£ظ…ط³';
    if (difference < 0) return 'ظ…ظ†ط° ${-difference} ظٹظˆظ…';
    if (difference <= 7) return 'ط®ظ„ط§ظ„ $difference ط£ظٹط§ظ…';
