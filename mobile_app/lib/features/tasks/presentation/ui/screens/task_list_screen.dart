              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'طھط¹ط°ط± ظ…ط²ط§ظ…ظ†ط© ط§ظ„ظ…ظ‡ط§ظ…. طھط­ظ‚ظ‚ ظ…ظ† ط§طھطµط§ظ„ظƒ.',
                      style: TextStyle(
                        fontSize: 12,
...
class _TaskFilterChips extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final filters = [
      {'label': 'ط§ظ„ظٹظˆظ…', 'value': TaskFilter.today},
      {'label': 'ط§ظ„ظ‚ط§ط¯ظ…ط©', 'value': TaskFilter.upcoming},
      {'label': 'ط§ظ„ظ…ظƒطھظ…ظ„ط©', 'value': TaskFilter.completed},
    ];
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Semantics(
                          label: 'طھطµظپظٹط©: ${filter['label'] as String}',
                          selected: isSelected,
                          button: true,
                          child: Text(
