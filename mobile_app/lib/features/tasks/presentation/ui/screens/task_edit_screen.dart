...
import 'package:almudeer_mobile_app/core/utils/permission_helper.dart';
...
import 'package:almudeer_mobile_app/features/tasks/presentation/widgets/legacy_tasks/task_share_dialog.dart';
...
class _TaskEditScreenState extends State<TaskEditScreen> {
  ...
  Future<void> _saveTask() async {
    ...
    if (_alarmEnabled && _selectedDate == null) {
      if (mounted) {
        AnimatedToast.error(
          context,
          'ظٹط±ط¬ظ‰ ط§ط®طھظٹط§ط± ط§ظ„طھط§ط±ظٹط® ط£ظˆظ„ط§ظ‹ ظ„طھظپط¹ظٹظ„ ط§ظ„طھظ†ط¨ظٹظ‡',
        );
      }
      if (mounted) {
        setState(() => _isSaving = false);
    ...
    if (_alarmEnabled && alarmTime != null && selectedDate != null) {
      ...
      if (alarmDateTime.isBefore(DateTime.now())) {
        if (mounted) {
          AnimatedToast.error(
            context,
            'ظ„ط§ ظٹظ…ظƒظ† ط§ط®طھظٹط§ط± ظˆظ‚طھ ظ…ط§ط¶ظچ ظ„ظ„طھظ†ط¨ظٹظ‡',
          );
        }
        if (mounted) {
          setState(() => _isSaving = false);
    ...
    try {
      ...
      if (_isNewTask) {
        ...
        if (provider.tasks.isNotEmpty) {
          ...
          if (mounted) {
            AnimatedToast.error(context, 'ظپط´ظ„ ط¥ظ†ط´ط§ط، ط§ظ„ظ…ظ‡ظ…ط©');
          }
      ...
      if (mounted && !_isOfflineError(e)) {
        AnimatedToast.error(context, 'ط­ط¯ط« ط®ط·ط£ ط£ط«ظ†ط§ط، ط§ظ„ط­ظپط¸');
      }
    } finally {
      if (mounted) {
        setState(() => _isSaving = false);
      ...
      child: Column(
        ...
        children: [
          ...
          AppTextField(
            ...
            hintText: 'ط¹ظ†ظˆط§ظ† ط§ظ„ظ…ظ‡ظ…ظژظ‘ط©',
          ...
          _canEdit && !_isLoadingPermissions
              ? AppTextField(
                  ...
                  hintText: 'ط§ظ„طھظژظ‘ظپط§طµظٹظ„ (ط§ط®طھظٹط§ط±ظٹ)',
                  prefixIcon: const Icon(
          ...
          AppTextField(
            ...
            hintText: 'ط§ظ„طھظژظ‘ط§ط±ظٹط® (ط§ط®طھظٹط§ط±ظٹ)',
            readOnly: true,
            onTap: _canEdit
                ? () {
                    Haptics.lightTap();
  ...
  Widget _buildRecurrenceSelector() {
    final recurrences = [
      {'label': 'ط¨ط¯ظˆظ† طھظƒط±ط§ط±', 'value': null},
      {'label': 'ظٹظˆظ…ظٹ', 'value': 'daily'},
      {'label': 'ط£ط³ط¨ظˆط¹ظٹ', 'value': 'weekly'},
      {'label': 'ط´ظ‡ط±ظٹ', 'value': 'monthly'},
    ];
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            _alarmTime?.format(context) ?? 'ط§ط®طھط± ط§ظ„ظˆظ‚طھ',
                            style: const TextStyle(
                              color: AppColors.primary,
                              fontWeight: FontWeight.bold,
                            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'ط£ط¶ظپ طھط§ط±ظٹط® ط§ظ„ظ…ظ‡ظ…ط© ط£ظˆظ„ط§ظ‹ ظ„طھظپط¹ظٹظ„ ط§ظ„طھظ†ط¨ظٹظ‡ط§طھ',
                    style: TextStyle(
  ...
  Widget _buildDescriptionReadOnly(ThemeData theme) {
    ...
    return Container(
      ...
      child: isEmpty
          ? Text(
              'ط§ظ„طھظژظ‘ظپط§طµظٹظ„ (ط§ط®طھظٹط§ط±ظٹ)',
              style: TextStyle(
