...
import 'package:almudeer_mobile_app/core/constants/app_config.dart';
...
class QRActionHandler {
  ...
  static Future<void> handleResult(
    ...
    if (isUrl) {
      ...
      if (!_isValidUrl(trimmedCode)) {
        ...
        if (context.mounted) {
          AnimatedToast.error(context, 'ط±ط§ط¨ط· ط؛ظٹط± طµط§ظ„ط­ ط£ظˆ ط؛ظٹط± ط¢ظ…ظ†');
        }
        return;
      }
      ...
      if (_isPotentiallyMalicious(trimmedCode)) {
        ...
        await _saveHistoryIfCallback(onSaveHistory, trimmedCode, type: scanType);
        if (context.mounted) {
          AnimatedToast.error(context, 'ظ‡ط°ط§ ط§ظ„ط±ط§ط¨ط· ظ‚ط¯ ظٹظƒظˆظ† ط¶ط§ط±ط§ظ‹');
        }
        return;
      }
      ...
      if (!_isValidDeepLinkPath(uri.path)) {
        ...
        await _saveHistoryIfCallback(onSaveHistory, trimmedCode, type: scanType);
        if (context.mounted) {
          AnimatedToast.error(context, 'ط±ط§ط¨ط· ط¯ط§ط®ظ„ظٹ ط؛ظٹط± طµط§ظ„ط­');
        }
        return;
      }
  ...
  static Future<void> _handleBackendQrCode(
    ...
    try {
      ...
      if (context.mounted) {
        AnimatedToast.error(context, 'ظپط´ظ„ ط§ظ„طھط­ظ‚ظ‚ ظ…ظ† ط±ظ…ط² QR');
      }
    }
  }
  ...
  static void _showQrVerificationSuccess(
    ...
    final title = qrCode?['title'] as String? ?? 'ط±ظ…ط² QR';
    ...
    PremiumBottomSheet.show(
      context: context,
      title: 'طھظ… ط§ظ„طھط­ظ‚ظ‚ ط¨ظ†ط¬ط§ط­',
      child: Column(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 12),
                  Text(
                    'ط§ظ„ط§ط³طھط®ط¯ط§ظ…ط§طھ: $useCount / $maxUses',
            ...
            children: [
              ...
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: const Text('ظپطھط­ ط§ظ„ط±ط§ط¨ط·'),
                  style: ElevatedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(vertical: 16),
                    backgroundColor: AppColors.primary,
                    foregroundColor: Colors.white,
        ...
        children: [
          ...
          ElevatedButton.icon(
            onPressed: () {
              ...
              if (!_isValidDeepLinkPath(uri.path)) {
                Navigator.pop(context);
                AnimatedToast.error(context, 'ط§ظ„ط±ط§ط¨ط· ط؛ظٹط± طµط§ظ„ط­');
                return;
              }
              ...
              try {
                ...
                if (context.mounted) {
                  AnimatedToast.error(context, 'ظپط´ظ„ ط§ظ„ط§ظ†طھظ‚ط§ظ„ ظ„ظ„طµظپط­ط©');
                }
              }
            },
            icon: const Icon(SolarLinearIcons.arrowRight),
            label: const Text('ط§ظ„ط§ظ†طھظ‚ط§ظ„'),
            style: ElevatedButton.styleFrom(
              padding: const EdgeInsets.symmetric(vertical: 16),
              backgroundColor: AppColors.primary,
              foregroundColor: Colors.white,
  ...
  static Future<void> _handlePlainText(BuildContext context, String text) async {
    ...
    PremiumBottomSheet.show(
      context: context,
      title: looksLikeUrl ? 'ظ†طµ ظ…ظ…ط³ظˆط­ (ط±ط§ط¨ط· ط؛ظٹط± طµط§ظ„ط­)' : 'ظ†طµ ظ…ظ…ط³ظˆط­',
      child: Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'ظٹط¨ط¯ظˆ ط£ظ† ظ‡ط°ط§ ط±ط§ط¨ط· ط؛ظٹط± طµط§ظ„ط­. طھط£ظƒط¯ ظ…ظ† طµط­ط© ط§ظ„ط±ظ…ط².',
                      style: TextStyle(
                        fontSize: 12,
