...
def upgrade() -> None:
    ...
    if not inspector.has_table('transfer_history'):
        op.create_table(
            'transfer_history',
    ...
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_transfer_history_status
    ...
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_transfer_history_device
