...
class CustomersRepository {
  ...
  Future<Map<String, dynamic>> addCustomer(Map<String, dynamic> data) async {
    ...
    if (phone != null && phone.isNotEmpty) {
      ...
      if (exists) {
        ...
        return {
          'success': true,
          'message': 'ط§ظ„ط¹ظ…ظٹظ„ ظ…ظˆط¬ظˆط¯ ظ…ط³ط¨ظ‚ط§ظ‹',
          'duplicate': true,
        };
      }
    }
    ...
    if (_connectivityService.isOffline) {
      return {
        'success': true,
        'message': 'طھظ…طھ ط¥ط¶ط§ظپط© ط§ظ„ط¹ظ…ظٹظ„ ظ…ط­ظ„ظٹظ‹ط§طŒ ط³ظٹطھظ… ط§ظ„ظ…ط²ط§ظ…ظ†ط© طھظ„ظ‚ط§ط¦ظٹظ‹ط§',
        'pending': true,
        'customer': {
          'id': localId,
          ...data,
  ...
  Future<Map<String, dynamic>> updateCustomer(
    ...
    if (_connectivityService.isOffline) {
      return {
        'success': true,
        'message': 'طھظ… طھط­ط¯ظٹط« ط§ظ„ط¨ظٹط§ظ†ط§طھ ظ…ط­ظ„ظٹط§ظ‹',
        'pending': true,
      };
    }
    ...
    try {
      ...
      if (errorStr.contains('404') || errorStr.contains('not found')) {
        ...
        try {
          ...
          return {
            ...
            'message': 'ظپط´ظ„ طھط­ط¯ظٹط« ط§ظ„ط¹ظ…ظٹظ„: $createError',
            'pending': true,
          };
        }
      }
      ...
      return {
        'success': false,
        'error': e.toString(),
        'message': 'ظپط´ظ„ ط§ظ„ط§طھطµط§ظ„ ط¨ط§ظ„ط®ط§ط¯ظ…طŒ ط³ظٹطھظ… ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ„ط§ط­ظ‚ط§ظ‹',
  ...
  Future<Map<String, dynamic>> deleteCustomer(int id) async {
    ...
    if (_connectivityService.isOffline) {
      return {
        'success': true,
        'message': 'طھظ… ط­ط°ظپ ط§ظ„ط´ظ‘ظژط®طµ ظ…ط­ظ„ظٹط§ظ‹',
        'pending': true,
      };
    }
    ...
    try {
      ...
      if (errorStr.contains('404') || errorStr.contains('not found')) {
        ...
        return {
          'success': true,
          'message': 'طھظ… ط§ظ„ط­ط°ظپ ط¨ظ†ط¬ط§ط­ (ط§ظ„ط¹ظ…ظٹظ„ ط؛ظٹط± ظ…ظˆط¬ظˆط¯ ط¹ظ„ظ‰ ط§ظ„ط®ط§ط¯ظ…)',
        };
      }

      return {
        'success': true,
        'message': 'طھظ… ط­ط°ظپ ط§ظ„ط´ظ‘ظژط®طµ ظ…ط­ظ„ظٹط§ظ‹ ظˆط³ظٹطھظ… ط§ظ„ظ…ط²ط§ظ…ظ†ط© ظ„ط§ط­ظ‚ط§ظ‹',
        'pending': true,
      };
    }
  }
  ...
  Future<Map<String, dynamic>> bulkDeleteCustomers(List<int> ids) async {
    ...
    if (_connectivityService.isOffline) {
      return {
        'success': true,
        'message': 'طھظ… ط­ط°ظپ ط§ظ„ط£ط´ط®ط§طµ ظ…ط­ظ„ظٹط§ظ‹ ظˆط³ظٹطھظ… ط§ظ„ظ…ط²ط§ظ…ظ†ط© ظ„ط§ط­ظ‚ط§ظ‹',
        'pending': true,
      };
    }
    ...
    try {
      ...
      return {'success': false, 'message': 'ط­ط¯ط« ط®ط·ط£ ط£ط«ظ†ط§ط، ط§ظ„ط§طھطµط§ظ„ ط¨ط§ظ„ط®ط§ط¯ظ…'};
    }
  }
