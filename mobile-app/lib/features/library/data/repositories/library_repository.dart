...
class LibraryRepository {
  ...
  Future<List<LibraryItem>> _fetchRemoteItems({
    ...
    if (response['success'] == true) {
      ...
      throw Exception(response['detail'] ?? 'ظپط´ظ„ ط¬ظ„ط¨ ط¹ظ†ط§طµط± ط§ظ„ظ…ظƒطھط¨ط©');
    }
  }
  ...
  Future<LibraryItem> uploadFile({
    ...
    if (!isConnected) {
      ...
      throw Exception('طھظ…طھ ط¥ط¶ط§ظپط© ط§ظ„ظ…ظ„ظپ ط¥ظ„ظ‰ ظ‚ط§ط¦ظ…ط© ط§ظ„ط§ظ†طھط¸ط§ط± (Offline)');
    }
    ...
    if (response['success'] == true) {
      ...
      throw Exception(response['detail'] ?? 'ظپط´ظ„ ط±ظپط¹ ط§ظ„ظ…ظ„ظپ');
    }
  }
  ...
  Future<Map<String, dynamic>> shareItem({
    ...
    if (response['success'] == true) {
      ...
      throw Exception(response['detail']?['message_ar'] ?? 'ظپط´ظ„ ظ…ط´ط§ط±ظƒط© ط§ظ„ط¹ظ†طµط±');
    }
  }
    ...
    if (response['success'] == true) {
      ...
      throw Exception(
        response['detail']?['message_ar'] ??
            ...
            'ظپط´ظ„ ط¬ظ„ط¨ ط§ظ„ط¹ظ†ط§طµط± ط§ظ„ظ…ط´طھط±ظƒط©',
      );
    }
  }
  ...
  Future<List<Map<String, dynamic>>> listItemShares(int itemId) async {
    ...
    if (response['success'] == true) {
      ...
      throw Exception(response['detail']?['message_ar'] ?? 'ظپط´ظ„ ط¬ظ„ط¨ ط§ظ„ظ…ط´ط§ط±ظƒط§طھ');
    }
  }
  ...
  Future<void> removeShare(int shareId) async {
    ...
    if (response['success'] != true) {
      throw Exception(
        response['detail']?['message_ar'] ?? 'ظپط´ظ„ ط¥ط²ط§ظ„ط© ط§ظ„ظ…ط´ط§ط±ظƒط©',
      );
    }
  }
  ...
  Future<void> updateSharePermission({
    ...
    if (response['success'] != true) {
      throw Exception(
        response['detail']?['message_ar'] ?? 'ظپط´ظ„ طھط­ط¯ظٹط« ط§ظ„طµظ„ط§ط­ظٹط©',
      );
    }
  }
  ...
  Future<Map<String, dynamic>> pairDevice({
    ...
    if (response['success'] == true) {
      ...
      throw Exception(response['detail']?['message_ar'] ?? 'ظپط´ظ„ ط§ظ‚طھط±ط§ظ† ط§ظ„ط¬ظ‡ط§ط²');
    }
  }
  ...
  Future<List<Map<String, dynamic>>> listPairedDevices() async {
    ...
    if (response['success'] == true) {
      ...
      throw Exception(
        response['detail']?['message_ar'] ?? 'ظپط´ظ„ ط¬ظ„ط¨ ط§ظ„ط£ط¬ظ‡ط²ط© ط§ظ„ظ…ظ‚طھط±ظ†ط©',
      );
    }
  }
  ...
  Future<void> unpairDevice(int pairingId) async {
    ...
    if (response['success'] != true) {
      throw Exception(
        response['detail']?['message_ar'] ?? 'ظپط´ظ„ ط¥ظ„ط؛ط§ط، ط§ظ„ط§ظ‚طھط±ط§ظ†',
      );
    }
  }
  ...
  Future<void> restoreFromTrash(int itemId) async {
    try {
      ...
      if (response['success'] != true) {
        throw Exception(
          response['detail']?['message_ar'] ?? 'ظپط´ظ„ ط§ظ„ط§ط³طھط¹ط§ط¯ط© ظ…ظ† ط³ظ„ط© ط§ظ„ظ…ظ‡ظ…ظ„ط§طھ',
        );
      }
    } catch (e) {
  ...
  Future<void> deletePermanently(int itemId) async {
    try {
      ...
      if (response['success'] != true) {
        throw Exception(
          response['detail']?['message_ar'] ?? 'ظپط´ظ„ ط§ظ„ط­ط°ظپ ط§ظ„ظ†ظ‡ط§ط¦ظٹ',
        );
      }
    } catch (e) {
  ...
  Future<void> emptyTrash() async {
    try {
      ...
      if (response['success'] != true) {
        throw Exception(
          response['detail']?['message_ar'] ?? 'ظپط´ظ„ ط¥ظپط±ط§ط؛ ط³ظ„ط© ط§ظ„ظ…ظ‡ظ…ظ„ط§طھ',
        );
      }
    } catch (e) {
  ...
  Future<void> restoreVersion(int itemId, int versionId) async {
    try {
      ...
      if (response['success'] != true) {
        throw Exception(
          response['detail']?['message_ar'] ?? 'ظپط´ظ„ ط§ط³طھط¹ط§ط¯ط© ط§ظ„ط¥طµط¯ط§ط±',
        );
      }
    } catch (e) {
