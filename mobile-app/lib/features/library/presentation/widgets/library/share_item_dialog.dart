...
class ShareItemDialog extends StatelessWidget {
  ...
  static void show(
    ...
    PremiumBottomSheet.show(
      context: context,
      title: 'ظ…ط´ط§ط±ظƒط© ظ…ط¨ط§ط´ط±ط© ظ…ط¹...',
      ...
      if (widget.taskIds != null) {
        ...
        if (mounted) {
          ...
          if (failCount > 0) {
            AnimatedToast.warning(
              context,
              'طھظ…طھ ظ…ط´ط§ط±ظƒط© $successCount ط¹ظ†ط§طµط± ظ…ط¹ $successfulUserCount ظ…ط³طھط®ط¯ظ…ظٹظ†طŒ ظپط´ظ„ $failCount ط¹ظ†ط§طµط± ظ…ط¹ $failedUserCount ظ…ط³طھط®ط¯ظ…ظٹظ†',
            );
          } else {
            AnimatedToast.success(
              context,
              'طھظ…طھ ظ…ط´ط§ط±ظƒط© $successCount ط¹ظ†ط§طµط± ظ…ط¹ ${_selectedUsernames.length} ظ…ط³طھط®ط¯ظ…ظٹظ†',
            );
          }
        }
      } else {
        ...
        if (mounted) {
          ...
          if (failCount > 0) {
            AnimatedToast.warning(
              context,
              'طھظ…طھ ط§ظ„ظ…ط´ط§ط±ظƒط© ظ…ط¹ $successCount ظ…ط³طھط®ط¯ظ…ظٹظ†طŒ ظپط´ظ„ $failCount',
            );
          } else {
            AnimatedToast.success(
              context,
              'طھظ…طھ ط§ظ„ظ…ط´ط§ط±ظƒط© ظ…ط¹ $successCount ظ…ط³طھط®ط¯ظ…ظٹظ†',
            );
          }
        }
      }
