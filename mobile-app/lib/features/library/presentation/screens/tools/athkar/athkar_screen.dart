...
class _AthkarScreenState extends State<AthkarScreen>
  ...
  void _showResetConfirmation(BuildContext context) {
    CustomDialog.show(
      context,
      title: 'ط¥ط¹ط§ط¯ط© ط¶ط¨ط· ط§ظ„ط£ط°ظƒط§ط±',
      message:
          'ظ‡ظ„ ط£ظ†طھ ظ…طھط£ظƒط¯ ظ…ظ† ط±ط؛ط¨طھظƒ ظپظٹ ط¥ط¹ط§ط¯ط© ط¶ط¨ط· ط¬ظ…ظٹط¹ ط¹ط¯ط§ط¯ط§طھ ط§ظ„ط£ط°ظƒط§ط± ظ„ظ‡ط°ط§ ط§ظ„ظٹظˆظ…طں',
      type: DialogType.warning,
      confirmText: 'ط¥ط¹ط§ط¯ط© ط¶ط¨ط·',
      cancelText: 'ط¥ظ„ط؛ط§ط،',
      onConfirm: () {
        context.read<AthkarProvider>().resetAll();
        AnimatedToast.success(context, 'طھظ…طھ ط¥ط¹ط§ط¯ط© ط¶ط¨ط· ط§ظ„ط¹ط¯ط§ط¯ط§طھ ط¨ظ†ط¬ط§ط­');
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'ط£ط°ظƒط§ط± ط§ظ„طµط¨ط§ط­ ظˆط§ظ„ظ…ط³ط§ط،',
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'ط¥ط¹ط§ط¯ط© ط¶ط¨ط· ط§ظ„ط¹ط¯ط§ط¯ط§طھ',
          ),
        ],
        bottom: TabBar(
          ...
          tabs: const [
            Tab(text: 'ط£ط°ظƒط§ط± ط§ظ„طµط¨ط§ط­'),
            Tab(text: 'ط£ط°ظƒط§ط± ط§ظ„ظ…ط³ط§ط،'),
          ],
        ),
      ),
      body: TabBarView(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'طھظ… ط¥ظƒظ…ط§ظ„ $completedCount ظ…ظ† ${widget.athkar.length} ط°ظƒط±ط§ظ‹',
                      style: TextStyle(
                        fontSize: 12,
                        fontFamily: 'IBM Plex Sans Arabic',
