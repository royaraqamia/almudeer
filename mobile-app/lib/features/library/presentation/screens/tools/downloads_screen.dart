...
class DownloadsScreen extends StatelessWidget {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'ظ„ط§ ظٹظˆط¬ط¯ طھط­ظ…ظٹظ„ط§طھ ط­ط§ظ„ظٹط§ظ‹',
  ...
  void _clearCompleted(BuildContext context, BrowserDownloadManager manager) {
    CustomDialog.show(
      context,
      title: 'ط­ط°ظپ ط§ظ„ظ…ظƒطھظ…ظ„ط©',
      message: 'ظ‡ظ„ طھط±ظٹط¯ ط­ط°ظپ ط¬ظ…ظٹط¹ ط§ظ„طھط­ظ…ظٹظ„ط§طھ ط§ظ„ظ…ظƒطھظ…ظ„ط©طں',
...
class _DownloadItemState extends State<_DownloadItem> {
                      ...
                      Row(
                        children: [
                          ...
                          if (widget.task.timeRemaining != null) ...[
                            ...
                            Text(
                              'ط§ظ„ظ…طھط¨ظ‚ظٹ: ${_formatDuration(widget.task.timeRemaining!)}',
                              style: TextStyle(
  ...
  String _getStatusText(DownloadStatus status) {
    switch (status) {
      ...
      case DownloadStatus.paused:
        return 'ظ…طھظˆظ‚ظپ ظ…ط¤ظ‚طھط§ظ‹';
      case DownloadStatus.failed:
        return 'ظپط´ظ„ ط§ظ„طھط­ظ…ظٹظ„';
      default:
        return 'ظ…ظ„ط؛ظ‰';
    }
  }
  ...
  String _formatDuration(Duration d) {
    if (d.inHours > 0) {
      return '${d.inHours} ط³ط§ط¹ط© ${d.inMinutes.remainder(60)} ط¯ظ‚ظٹظ‚ط©';
    } else if (d.inMinutes > 0) {
      return '${d.inMinutes} ط¯ظ‚ظٹظ‚ط©';
    } else {
      return '${d.inSeconds} ط«ط§ظ†ظٹط©';
    }
  }
}
