...
import 'package:almudeer_mobile_app/core/extensions/string_extension.dart'; // Added this import
...
import 'package:almudeer_mobile_app/features/inbox/presentation/utils/chat_grouping_helper.dart';
import 'package:almudeer_mobile_app/features/inbox/presentation/widgets/chat/chat_widgets.dart';
...
class _MessageListViewState extends State<MessageListView> {
  ...
  void didUpdateWidget(MessageListView oldWidget) {
    ...
    if (messagesStructureChanged) {
      ...
      if (widget.messages.length > oldWidget.messages.length) {
        ...
        // older messages at the end (pagination) â€“ don't count those.
    ...
    if (targetIndex != -1) {
      ...
      if (provider.hasMore && _scrollRetryCount < _maxScrollRetries) {
        if (_scrollRetryCount == 0) {
          AnimatedToast.info(context, 'ط¬ط§ط±ظٹ ط§ظ„ط¨ط­ط« ط¹ظ† ط§ظ„ط±ط³ط§ظ„ط©...');
        }
        ...
        _pendingScrollId = null;
        _scrollRetryCount = 0;
        AnimatedToast.info(context, 'ط§ظ„ط±ط³ط§ظ„ط© ط؛ظٹط± ظ…ظˆط¬ظˆط¯ط© ظپظٹ ط§ظ„ظ‚ط§ط¦ظ…ط© ط§ظ„ط­ط§ظ„ظٹط©');
      }
    }
  }
  ...
  void _showRetryDialog(int? messageId, String? platformId) {
    ...
    CustomDialog.show(
      context,
      title: 'ط§ظ„ط±ط³ط§ظ„ط© ط؛ظٹط± ظ…ظˆط¬ظˆط¯ط©',
      message:
          'ظ„ظ… ظ†طھظ…ظƒظ† ظ…ظ† ط§ظ„ط¹ط«ظˆط± ط¹ظ„ظ‰ ظ‡ط°ظ‡ ط§ظ„ط±ط³ط§ظ„ط©. ظ‡ظ„ طھط±ظٹط¯ طھط­ظ…ظٹظ„ ط§ظ„ظ…ط²ظٹط¯ ظ…ظ† ط§ظ„ط±ط³ط§ط¦ظ„طں',
      type: DialogType.info,
      confirmText: 'طھط­ظ…ظٹظ„ ط§ظ„ظ…ط²ظٹط¯',
    ...
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, show, child) {
        ...
        return Stack(
          ...
          children: [
            Semantics(
              label: 'ط§ظ†طھظ‚ط§ظ„ ط¥ظ„ظ‰ ط£ط­ط¯ط« ط§ظ„ط±ط³ط§ط¦ظ„',
              button: true,
