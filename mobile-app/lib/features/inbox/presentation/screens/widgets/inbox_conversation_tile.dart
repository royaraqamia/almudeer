...
class _InboxConversationTileState extends State<InboxConversationTile>
  ...
  bool get _hasAttachments {
    ...
    return preview.startsWith('ًں“ژ') ||
        preview.startsWith('طµظˆط±ط©') ||
        preview.startsWith('ظپظٹط¯ظٹظˆ') ||
        preview.startsWith('ظ…ظ„ظپ') ||
        preview.startsWith('طµظˆطھظٹ');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label:
          '${widget.conversation.displayName}طŒ ${widget.conversation.channelDisplayName}طŒ ${widget.conversation.displayPreview}${hasUnread ? 'طŒ ${widget.conversation.unreadCount} ط±ط³ط§ط¦ظ„ ط؛ظٹط± ظ…ظ‚ط±ظˆط،ط©' : ''}${isPinned ? 'طŒ ظ…ط«ط¨طھط©' : ''}',
      button: true,
