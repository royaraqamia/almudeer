...
import 'package:almudeer_mobile_app/features/inbox/presentation/screens/widgets/inbox_conversation_tile.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.allowBulkSelection ? ' ظ…ط´ط§ط±ظƒط© ظ…ط¹...' : 'ظ…ط´ط§ط±ظƒط© ظ…ط¹...',
                    ...
                    if (conversations.isEmpty) {
                      return const SliverToBoxAdapter(
                        child: Padding(
                          ...
                          child: Text(
                            'ظ„ط§ طھظˆط¬ط¯ ظ…ط­ط§ط¯ط«ط§طھ ظ…ط·ط§ط¨ظ‚ط©',
                    ...
                    if (customers.isEmpty) {
                      return const SliverToBoxAdapter(
                        child: Padding(
                          padding: EdgeInsets.all(16.0),
                          child: Text(
                            'ظ„ط§ طھظˆط¬ط¯ ط¬ظ‡ط§طھ ط§طھطµط§ظ„ ظ…ط·ط§ط¨ظ‚ط©',
                            textAlign: TextAlign.center,
                          ),
                        ),
                      );
