...
import 'package:almudeer_mobile_app/core/services/sound_service.dart';
...
class ConversationDetailProvider extends ChangeNotifier {
  ...
  Future<void> loadConversation(
    ...
    // Initialize presence: always start with offline to avoid stale "ظ…طھطµظ„ ط§ظ„ط¢ظ†" flash.
  ...
  Future<void> loadMoreMessages() async {
    ...
    try {
      ...
      if (errorStr.contains('socket') ||
        ...
        _failure = const NetworkFailure('ظ„ط§ ظٹظˆط¬ط¯ ط§طھطµط§ظ„ ط¨ط§ظ„ط¥ظ†طھط±ظ†طھ');
      } else {
        _failure = const ServerFailure('ظپط´ظ„ طھط­ظ…ظٹظ„ ط§ظ„ظ…ط²ظٹط¯ ظ…ظ† ط§ظ„ط±ط³ط§ط¦ظ„');
      }
    }
  ...
  Future<bool> editMessage(int messageId, String newBody) async {
    ...
    try {
      ...
      _inboxRepository.editMessage(messageId, newBody).catchError((e) {
        ...
        onError?.call('ظپط´ظ„ ظ…ط²ط§ظ…ظ†ط© ط§ظ„طھط¹ط¯ظٹظ„: ${e.toString()}');
