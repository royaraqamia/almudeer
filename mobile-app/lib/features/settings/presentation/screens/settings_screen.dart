...
import 'package:almudeer_mobile_app/core/constants/shadows.dart';
...
import 'package:almudeer_mobile_app/core/widgets/app_gradient_icon.dart';
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'ظ‡ظ„ ط£ظ†طھ ظ…طھط£ظƒط¯ ظ…ظ† ط­ط°ظپ ظ‡ط°ط§ ط§ظ„ظ…ط³طھظ†ط¯طں',
        ...
        children: [
                ...
                Container(
                  ...
                  child: AppTextField(
                    ...
                    hintText: _editingDoc != null
                        ? 'ط¹ط¯ظ‘ظ„ ط§ظ„ظ†طµ...'
                        : 'ط£ط¯ط®ظ„ ظ…ط¹ظ„ظˆظ…ط§طھ ط¬ط¯ظٹط¯ط©...',
                    height: 144,
                    maxHeight: 144,
          ...
          AppGradientButton(
            ...
            text: provider.isUploading
                ? 'ط¬ط§ط±ظٹ ط§ظ„ط±ظپط¹... ${provider.uploadProgress.toStringAsFixed(0)}%'
                : 'ط§ط®طھظٹط§ط± ظ…ظ„ظپط§طھ',
            textColor: AppColors.primary,
            gradientColors: [
              AppColors.primary.withValues(alpha: 0.1),
              AppColors.primary.withValues(alpha: 0.05),
          ...
          const SizedBox(height: AppDimensions.spacing8),
          Text(
            'ط§ظ„ط­ط¯ ط§ظ„ط£ظ‚طµظ‰ ظ„ط­ط¬ظ… ط§ظ„ظ…ظ„ظپ: 20 ظ…ظٹط¬ط§ط¨ط§ظٹطھ',
          ...
          if (provider.isUploading) ...[
            ...
            if (provider.uploadingFileName != null) ...[
              const SizedBox(height: AppDimensions.spacing4),
              Text(
                'ط¬ط§ط±ظٹ ط±ظپط¹: ${provider.uploadingFileName}',
                style: theme.textTheme.bodySmall?.copyWith(
                  color: AppColors.primary,
                ),
                textAlign: TextAlign.center,
