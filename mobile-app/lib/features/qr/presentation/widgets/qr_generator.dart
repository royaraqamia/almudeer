...
class QRGenerator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    try {
      return Semantics(
        label: semanticLabel ?? 'ط±ظ…ط² QR ظٹط­طھظˆظٹ ط¹ظ„ظ‰: $data',
        image: true,
...
class QRGeneratorBottomSheet {
  ...
  static void show(
    ...
    if (!QRGenerator.isValidData(data)) {
      AnimatedToast.error(context, 'ط¨ظٹط§ظ†ط§طھ ط§ظ„ط±ظ…ط² ط؛ظٹط± طµط§ظ„ط­ط©');
      return;
    }
...
class _QRBottomSheetContentState extends State<_QRBottomSheetContent> {
  ...
  Future<void> _shareQrCode() async {
    ...
    try {
      ...
      if (mounted) {
        AnimatedToast.error(context, 'ظپط´ظ„ ط§ظ„ظ…ط´ط§ط±ظƒط©');
      }
    } catch (e) {
      debugPrint('Share failed: $e');
      if (mounted) {
        AnimatedToast.error(context, 'ظپط´ظ„ ط§ظ„ظ…ط´ط§ط±ظƒط©: ${e.toString()}');
      }
    } finally {
      if (mounted) {
        setState(() {
  ...
  void _copyToClipboard() {
    ...
    AnimatedToast.info(context, 'طھظ… ط§ظ„ظ†ط³ط® ط¥ظ„ظ‰ ط§ظ„ط­ط§ظپط¸ط©');
  }
        ...
        children: [
          ...
          Container(
            ...
            child: QRGenerator(
              data: widget.data,
              size: widget.size,
              semanticLabel: '${widget.title}: ط±ظ…ط² QR',
            ),
          ),
                ...
                children: [
                  ...
                  if (widget.data.length > 100)
                    TextButton(
                      ...
                      child: Text(
                        _showFullData ? 'ط¥ط®ظپط§ط،' : 'ط¹ط±ط¶ ط§ظ„ط¨ظٹط§ظ†ط§طھ ط§ظ„ظƒط§ظ…ظ„ط©',
            ...
            children: [
              ...
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: Text(_isSharing ? 'ط¬ط§ط±ظٹ...' : 'ظ…ط´ط§ط±ظƒط©'),
