...
class TaskSyncService {
  ...
  Future<TaskModel> createTask(TaskModel task) async {
    ...
    try {
      ...
      throw _createLocalizedApiException(e, 'ط¥ط¶ط§ظپط© ط§ظ„ظ…ظ‡ظ…ط©');
    } catch (e, st) {
      debugPrint('TaskSyncService: Failed to create task with attachments: $e');
      debugPrint('Stack trace: $st');
      // Re-throw with localized message
      throw Exception('ظپط´ظ„ ط¥ط¶ط§ظپط© ط§ظ„ظ…ظ‡ظ…ط©. ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ…ط±ط© ط£ط®ط±ظ‰');
    }
  }
  ...
  Exception _createLocalizedApiException(ApiException e, String operation) {
    ...
    if (e.statusCode == 400) {
      ...
      return Exception('ط¨ظٹط§ظ†ط§طھ $operation ط؛ظٹط± طµط­ظٹط­ط©');
    } else if (e.statusCode == 401) {
      return Exception('ط؛ظٹط± ظ…طµط±ط­ ظ„ظƒ ط¨ظ€ $operation');
    } else if (e.statusCode == 403) {
      return Exception('ظ„ظٹط³ ظ„ط¯ظٹظƒ طµظ„ط§ط­ظٹط© $operation');
    } else if (e.statusCode == 404) {
      return Exception('$operation ط؛ظٹط± ظ…ظˆط¬ظˆط¯ط©');
    } else if (e.statusCode == 409) {
      return Exception('ط­ط¯ط« طھط¹ط§ط±ط¶ ط£ط«ظ†ط§ط، $operation. ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ…ط±ط© ط£ط®ط±ظ‰');
    } else if (e.statusCode == 413) {
      return Exception('ط­ط¬ظ… ط§ظ„ظ…ظ„ظپ ظٹطھط¬ط§ظˆط² ط§ظ„ط­ط¯ ط§ظ„ظ…ط³ظ…ظˆط­');
    }
    // Default message with error code for debugging
    return Exception(
      'ظپط´ظ„ $operation (${e.statusCode ?? 0}). ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ…ط±ط© ط£ط®ط±ظ‰',
    );
  }
  ...
  Future<TaskModel> updateTask(TaskModel task) async {
    ...
    try {
      ...
      throw _createLocalizedApiException(e, 'طھط­ط¯ظٹط« ط§ظ„ظ…ظ‡ظ…ط©');
    } catch (e) {
      debugPrint('TaskSyncService: Failed to update task with attachments: $e');
      throw Exception('ظپط´ظ„ طھط­ط¯ظٹط« ط§ظ„ظ…ظ‡ظ…ط©. ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ…ط±ط© ط£ط®ط±ظ‰');
    }
  }
  ...
  Future<Map<String, dynamic>> shareTask({
    ...
    try {
      ...
      if (e.statusCode == 403) {
        throw Exception('ظ„ظٹط³ ظ„ط¯ظٹظƒ طµظ„ط§ط­ظٹط© ظ…ط´ط§ط±ظƒط© ظ‡ط°ظ‡ ط§ظ„ظ…ظ‡ظ…ط©');
      } else if (e.statusCode == 404) {
        throw Exception('ط§ظ„ظ…ظ‡ظ…ط© ط؛ظٹط± ظ…ظˆط¬ظˆط¯ط©');
      ...
      throw Exception('ط­ط¯ط« ط®ط·ط£ ط؛ظٹط± ظ…طھظˆظ‚ط¹ ط£ط«ظ†ط§ط، ظ…ط´ط§ط±ظƒط© ط§ظ„ظ…ظ‡ظ…ط©');
    }
  }
