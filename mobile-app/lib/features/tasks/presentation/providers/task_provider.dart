...
import 'package:almudeer_mobile_app/features/tasks/utils/task_logger.dart';
...
class TaskProvider extends ChangeNotifier {
  ...
  Future<void> addTask({
    ...
    try {
      ...
      _tasksRevisionTracker++; // Invalidates cache
      _setError('ظپط´ظ„ ط¥ط¶ط§ظپط© ط§ظ„ظ…ظ‡ظ…ط©. ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ…ط±ط© ط£ط®ط±ظ‰');
      notifyListeners();
    }
  }
  ...
  Future<void> toggleTaskStatus(TaskModel task) async {
    ...
    try {
      ...
      _setError('ظپط´ظ„ طھط­ط¯ظٹط« ط­ط§ظ„ط© ط§ظ„ظ…ظ‡ظ…ط©. ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ…ط±ط© ط£ط®ط±ظ‰');
  ...
  Future<TaskModel?> deleteTask(String id, {bool showUndo = false}) async {
    ...
    try {
      ...
      _setError('ظپط´ظ„ ط­ط°ظپ ط§ظ„ظ…ظ‡ظ…ط©. ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ…ط±ط© ط£ط®ط±ظ‰');
      // Rollback
  ...
  Future<void> updateTask(TaskModel task) async {
    ...
    try {
      ...
      _setError('ظپط´ظ„ طھط­ط¯ظٹط« ط§ظ„ظ…ظ‡ظ…ط©. ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ…ط±ط© ط£ط®ط±ظ‰');
      await loadTasks(triggerSync: false);
    }
  }
