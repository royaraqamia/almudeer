...
class _TaskListItemState extends State<TaskListItem>
      ...
      onTap: () {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              previousState
                  ? 'طھظ… ط¥ط¹ط§ط¯ط© ظپطھط­ ط§ظ„ظ…ظ‡ظ…ط©'
                  : 'طھظ… ط¥ظƒظ…ط§ظ„ ط§ظ„ظ…ظ‡ظ…ط©',
            ),
  ...
  String _getRelativeDate(DateTime date) {
    ...
    if (difference == 0) {
      ...
      return 'ط¨ط¹ط¯ $difference ط£ظٹط§ظ…';
    } else if (difference < -1 && difference >= -7) {
      return 'ظ…ظ†ط° ${-difference} ط£ظٹط§ظ…';
    } else {
  ...
  String _getRecurrenceLabel(String recurrence) {
    switch (recurrence) {
      case 'daily':
        return 'ظٹظˆظ…ظٹظ‹ظ‘ط§';
      case 'weekly':
        return 'ط£ط³ط¨ظˆط¹ظٹظ‹ظ‘ط§';
      case 'monthly':
        return 'ط´ظ‡ط±ظٹظ‹ظ‘ط§';
      default:
        return '';
    }
  }
