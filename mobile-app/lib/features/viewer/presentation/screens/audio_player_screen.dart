    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      if (mounted) {
        try {
          ...
          if (path != null) {
            await provider.playAudioFile(path, widget.fileName ?? 'ظ…ظ‚ط·ط¹ طµظˆطھظٹ');
          }
        } catch (e) {
          if (mounted) {
            setState(() {
            ...
            PremiumToast.show(
              context,
              'ظپط´ظ„ طھط´ط؛ظٹظ„ ط§ظ„طµظˆطھ: ${e.toString()}',
            ...
            body: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    _errorMessage ?? 'ط®ط·ط£ ط؛ظٹط± ظ…ط¹ط±ظˆظپ',
